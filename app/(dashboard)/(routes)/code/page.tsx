  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const data = {
        ...
        query:
          "You are a code generation assistant. When given a description or requirements, your task is to generate the corresponding code snippet only, without any explanations, comments, or additional information." +
          values.prompt,
